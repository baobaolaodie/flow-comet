...
<p align="center">
  ...
  <a href="CHANGELOG.md"><img src="https://img.shields.io/badge/version-1.2.1-blue.svg" alt="Version" /></a>
</p>
...
3. Run regression: `node .claude/skills/flow-comet/scripts/guard-self-test.mjs` → `ALL 77 SCENARIOS PASSED`
