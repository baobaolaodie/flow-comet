...
|----------|------------------|
| **阶段协议**（prompts/0-change、1-requirement、2-design、3-task、4-dev、5-test、6-review、7-integration、2a-ui-design） | 8 节点一一对应；节点 skill 自述「flow-kit \<阶段\> 阶段协议」，执行时读取 flow-kit prompt 文件 |
