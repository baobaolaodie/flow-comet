...
- **Publish/distribute** (creator/publish/bundle backend, 33-platform installer, skill-preferences): not adopted — flow-comet is installed by copying the skill tree into the target project (see [Installation](INSTALLATION.md))
