...
- **Repo**: clone, then verify the regression baseline runs:
  `node .comet/bundle-drafts/flow-comet/skills/flow-comet/scripts/guard-self-test.mjs` → `ALL 106 SCENARIOS PASSED`
...
- **Regression baseline**: `node .comet/bundle-drafts/flow-comet/skills/flow-comet/scripts/guard-self-test.mjs` → `ALL 106 SCENARIOS PASSED` (mandatory after every change)
...
- Verification: regression (106 scenarios) / installed-copy checks
