...
<p align="center">
  ...
  <a href="CHANGELOG-zh.md"><img src="https://img.shields.io/badge/version-1.2.2-blue.svg" alt="Version" /></a>
</p>
...
3. 运行回归：`node .claude/skills/flow-comet/scripts/guard-self-test.mjs` → `ALL 77 SCENARIOS PASSED`
