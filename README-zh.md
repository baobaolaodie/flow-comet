...
<p align="center">
  ...
  <a href="CHANGELOG-zh.md"><img src="https://img.shields.io/badge/version-1.5.0--rc.2-blue.svg" alt="Version" /></a>
</p>
...
3. 运行回归：`node .flow-comet/skills/flow-comet/scripts/guard-self-test.mjs` → `ALL 238 SCENARIOS PASSED`
