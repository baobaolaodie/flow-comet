...
<p align="center">
  ...
  <a href="CHANGELOG-zh.md"><img src="https://img.shields.io/badge/version-1.2.3-blue.svg" alt="Version" /></a>
</p>
...
3. 运行回归：`node .claude/skills/flow-comet/scripts/guard-self-test.mjs` → `ALL 82 SCENARIOS PASSED`
