...
7. **Update workflow state**: Run `node .claude/skills/flow-comet/scripts/workflow-state.mjs record archive '{"summary":"Change archived"}'` to record completion evidence.
...
- Workflow state has been updated (archive evidence recorded).
