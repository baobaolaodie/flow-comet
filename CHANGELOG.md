...
- Regression suite expanded to 112 scenarios covering skill-load declaration markers, record validation against declaration markers, exit protocol declaration checks, cross-consistency timestamps, legacy compatibility, and review finding disposition checks.
