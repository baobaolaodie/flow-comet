...
- [ ] 回归测试 / Regression：`node .comet/bundle-drafts/flow-comet/skills/flow-comet/scripts/guard-self-test.mjs` → ALL 144 SCENARIOS PASSED + `node .comet/bundle-drafts/flow-comet/skills/flow-comet/scripts/system-test.mjs` → ALL SYSTEM TESTS PASSED
