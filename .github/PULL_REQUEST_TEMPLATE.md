...
- [ ] 回归测试 / Regression：`node .flow-comet/skills/flow-comet/scripts/guard-self-test.mjs` → ALL 247 SCENARIOS PASSED + `node .flow-comet/skills/flow-comet/scripts/system-test.mjs` → ALL SYSTEM TESTS PASSED
